...
module.exports = {
	relationPostAuthor: async (req, res) => {
		...
		try {
			...
			// Posts relationships
			await relationModel.relationPostSourceText(posts, 'post')
			console.log("#### Post - Souce_Text relationship: DONE #### \n")

			await relationModel.relationPostSourceImage(posts, 'post')
			console.log("#### Post - Souce_Image relationship: DONE #### \n")

			await relationModel.relationPostSourceSuperImage(posts, 'post')
			console.log("#### Post - Souce_Super_Image relationship: DONE #### \n")
